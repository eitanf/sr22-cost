---
## A relatively current output of this script can be found at: http://rpubs.com/etc_26/sr22
...
check = data.frame(Gen=as.factor("G3"), Turbo=as.factor("N"), TKS=TRUE, AC=TRUE, SVT=TRUE, ESP=TRUE, EVS=TRUE, YD=TRUE, Age=5, TTSN=600, Warranty.mos=0)
predict(fit, newdata=check)
# Which can also be manually extrapolated as:
578.23 + 88.07*0 + (-17.34*5) + (-0.0754*600) + 41.29 + 17.72 + 19.72 + 12.47 + (-67.72)
```